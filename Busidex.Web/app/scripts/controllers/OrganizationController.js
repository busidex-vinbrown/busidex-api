    ...
    function getReferrals() {
        ...
        function (cardsData) {
            ...
            for (var i = 0; i < cardsData.Model.length; i++) {
                ...
                if (card.Notes !== null) {
                    card.Notes = window.unescape(card.Notes);
                }
                card.OrientationClass = card.FrontOrientation === 'V' ? 'v_preview' : 'h_preview';
                //card.Selected = false;
    ...
    function share() {
        ...
        SharedCard.post(sharedCards,
            function () {
                ...
                window.alert('Your referrals have been submitted to the organization.');
            },
            function () {
                window.alert('There was a problem sharing your referrals.');
            });
    }
