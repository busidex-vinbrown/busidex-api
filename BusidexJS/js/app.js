...
//if (window.location.href.indexOf('local.') < 0 && window.location.href.indexOf('pro.') < 0) {
//    var newLocation = window.location.href;
//    newLocation = newLocation.replace('http:', 'https:');
//    //newLocation = newLocation.replace('https://', 'https://');
...
angular.module('Busidex', ['Busidex.filters', 'Busidex.services', 'Busidex.directives', 'ngCookies', 'ui.bootstrap', 'ngResource', 'ngSanitize', 'ngRoute', 'ngGrid', 'ngAnimate', 'angular-google-analytics', 'ui.bootstrap.popover', 'textAngular'/*, 'satellizer'*/]).
    config(['$routeProvider', '$httpProvider', 'AnalyticsProvider', '$locationProvider', '$provide', function ($routeProvider, $httpProvider, AnalyticsProvider, $locationProvider, $provide) {
        ...
        $httpProvider.defaults.headers.common['Set-Cookie'] = ';domain=.busidx.com';
        ...
        $routeProvider.when('/lizzabethbrown', { redirectTo: 'https://profile.busidex.com/details/Lizzabeth-Brown-Keller-Williams-Realty', controller: CardDetailCtrl });
        ...
        .when('/RealtorConference2014', { templateUrl: 'partials/vanity/riarexpo.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
        ...
        .when('/bnistars', { templateUrl: 'partials/vanity/bnistars.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
        .when('/riarexpo', { templateUrl: 'partials/vanity/riarexpo.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
        .when('/minutemanpress', { templateUrl: 'partials/vanity/minutemanpress.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
        ...
        .when('/admin/devicedetails', { templateUrl: 'partials/admin/devicedetails.html?' + CACHE_VERSION, controller: 'AdminCtrl' })
        ...
        .when('/newsletters/newsletter_7', { templateUrl: 'partials/newsletters/newsletter_7.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
            ...
            .when('/raytheon', { templateUrl: 'partials/raytheon.html?' + CACHE_VERSION, controller: 'GenericViewCtrl' })
