...
namespace DotNetOpenAuth.ApplicationBlock
{
    ...
    public static class GoogleConsumer
    {
        ...
        public static XDocument GetContacts(string key, string secret)
        {
            var tokenManager = new InMemoryTokenManager(key, secret);
            ...
            return GetContacts(google, token, 5, 1);
        }
        /// <summary>
        ...
        private static XDocument GetContacts(ConsumerBase consumer, string accessToken, int maxResults/* = 25*/, int startIndex/* = 1*/)
        {
            if (consumer == null)
            {
                throw new ArgumentNullException("consumer");
