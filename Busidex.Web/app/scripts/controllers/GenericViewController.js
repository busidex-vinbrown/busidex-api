Busidex.controller('GenericViewCtrl', [
    '$http', '$scope', '$rootScope', '$cookieStore', 'Activity',
        function($http, $scope, $rootScope, $cookieStore, Activity) {
            'use strict';
            ...
            var token = $rootScope.User !== undefined ? $rootScope.User.Token : null;
            $http.defaults.headers.common['X-Authorization-Token'] = token;

            if ($rootScope.User !== undefined && $rootScope.User.Token === null) {
                $rootScope.User = null;
            ...
            $rootScope.LoginModel = {
                ...
                HomeLink: $rootScope.User !== undefined && $rootScope.User.StartPage === 'Organization' ? '#/groups/organization/' + $rootScope.User.Organizations[0].Item2 : '#/home'
            };
            ...
            var acctType = $rootScope.User !== undefined ? parseInt($rootScope.User.AccountTypeId) : 0;
            ...
            $rootScope.ShowMemberships = function() {
                ...
                var hasOrgs = false;
                acctType = $rootScope.User !== undefined ? parseInt($rootScope.User.AccountTypeId) : 0;
                if ($rootScope.IsLoggedIn && $rootScope.User !== undefined && $rootScope.User.Organizations !== null && acctType !== ACCT_TYPE_ORGANIZATION) {
            ...
            $rootScope.HomeEditLink = ($rootScope.User !== undefined && $rootScope.User.HasCard) ? '#/card/edit/' + $rootScope.User.CardId + '?details=true' : '#/card/add';
            $rootScope.HomeTagLink = ($rootScope.User !== undefined && $rootScope.User.HasCard) ? '#/card/edit/' + $rootScope.User.CardId + '?tags=true' : '#/card/add';
